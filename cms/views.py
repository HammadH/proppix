...
class Dubizzle(View):
        ...
        def get(self, request, *args, **kwargs):
                return HttpResponse(open('/home/hammad/test_feed_file.xml').read())
        ...
        def post(self, request, *args, **kwargs):
			...
			print '%s' %dbz_soup
                        # 2. soup feed_file
                        feed_file = open('/home/hammad/test_feed_file.xml', 'rb', bufsize)
                        ...
                        feed_file = open('/home/hammad/test_feed_file.xml', 'wb', bufsize)
                        if existing_listing:
	...
	print 'passed bedrooms'
		...
		print 'checking features'
                if feature.text in DBZ_AMENITIES:
                    amenities.iappend(DBZ_AMENITIES[feature.text])
...
def build_image_path(refno, imgId=None, imgCaption=None):
        ...
        if imgId is not None:
                ...
                print folder_path
                try:
                        os.makedirs('/home/hammad/webapps/zentest/zentest/zentest/media'+folder_path)
                except Exception, e:
                        print e
                        pass
                paths = {
